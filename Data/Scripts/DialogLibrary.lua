...
AddText(1,"I'm at Fort Williams Campground, not far from the entrance. I am on the main road in a black sedan.}TextColor44")
...
AddText(2,"Thank you, Earl. I'm at the Fort William campsite just near MapleRidge Park, about five miles from the railroad tracks. You can't miss my car, it's a black sedan.}TextColor44")
...
AddText(4,"I'm at the Fort William Campsite, near Maple Ridge Park about 5 miles from the railroad tracks. My car is on the main road, it’s a black sedan.}TextColor44")
...
AddText(9,"Oh my. I'd like to help you, John. I'm fishing at a nearby lake, and it's only about 10 minutes away from the campsite. I'll head over right away. Can you wait that long?}TextColor9")
...
AddText(12,"I'm at Fort William Campsite, and my car is on the main road, near Thunder Lake on the main road. Im in a black sedan.}TextColor44")
